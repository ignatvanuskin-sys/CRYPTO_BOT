...
def main_menu() -> ReplyKeyboardMarkup:
    # Primary per spec 4: Торговать / Мои позиции / Лидерборд / Профиль
    # Secondary: История / Соревнование / Помощь
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="Торговать", icon_custom_emoji_id=CHART_UP_ID), KeyboardButton(text="Мои позиции", icon_custom_emoji_id=CHART_ID)],
            [KeyboardButton(text="Лидерборд", icon_custom_emoji_id=GOLD_ID), KeyboardButton(text="Профиль", icon_custom_emoji_id=CROWN_ID)],
            [KeyboardButton(text="История", icon_custom_emoji_id=BOOKMARK_ID), KeyboardButton(text="Соревнование", icon_custom_emoji_id=CHART_ID), KeyboardButton(text="Помощь", icon_custom_emoji_id=PIN_ID)],
        ],
